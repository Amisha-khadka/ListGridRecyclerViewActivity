...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewButton.setOnClickListener(v -> {
            Intent intent = new Intent(MainActivity.this, com.Amisha.myapplication.ListViewActivity.class);
            intent.putStringArrayListExtra("dataList", dataList);
            startActivity(intent);
        });

        gridViewButton.setOnClickListener(v -> {
            Intent intent = new Intent(MainActivity.this, com.Amisha.myapplication.GridViewActivity.class);
            intent.putStringArrayListExtra("dataList", dataList);
            startActivity(intent);
        });
